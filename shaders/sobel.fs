...
void main(void) {
  ...
  vec4 tx0y0 = texture2D(sampler0, x0y0 - offset);
  vec4 tx0y1 = texture2D(sampler0, x0y1 - offset);
  vec4 tx0y2 = texture2D(sampler0, x0y2 - offset);

  vec4 tx1y0 = texture2D(sampler0, x1y0 - offset);
  vec4 tx1y1 = texture2D(sampler0, x1y1 - offset);
  vec4 tx1y2 = texture2D(sampler0, x1y2 - offset);

  vec4 tx2y0 = texture2D(sampler0, x2y0 - offset);
  vec4 tx2y1 = texture2D(sampler0, x2y1 - offset);
  vec4 tx2y2 = texture2D(sampler0, x2y2 - offset);
